...
function replayfun()
  composer.removeScene("replay9" )
  composer.gotoScene( "replay9")
end
...
function generatecoin()
  coin=display.newImage(enemygroup,"images/coin.png")
  coin.width=22
  coin.height=22
  ...
  randnum=math.random(2)
     if(randnum==1)then
       coin.x= math.random(screenLeft+58,screenLeft+200)
       coin.y=math.random(screenTop+40, screenTop+278)
     elseif(randnum==2)then
       coin.x= math.random(screenLeft+300,screenLeft+430)
       coin.y=math.random(screenTop+40, screenTop+278)
     end
...
function flybackup6(obj)
--  print("flyback up there")
--  transition.to( obj, {time=4000,y=60} )
  transition.to( obj, {time=timer,x=screenLeft+160,y=screenTop+50  ,onComplete=flybackup} )
  randomtime()
end

function flybackup5(obj)
--  print("flyback up there")
--  transition.to( obj, {time=4000,y=60} )
  transition.to( obj, {time=timer,x=screenLeft+100,y=screenBottom-65  ,onComplete=flybackup6} )
  randomtime()
end

function flybackup4(obj)
--  print("flyback up there")
--  transition.to( obj, {time=4000,y=60} )
  transition.to( obj, {time=timer,x=screenLeft+160,y=screenTop+50  ,onComplete=flybackup5} )
  randomtime()
end


function flybackup3(obj)
--  print("flyback up there")
--  transition.to( obj, {time=4000,y=60} )
  transition.to( obj, {time=timer,x=screenLeft+230,y=screenBottom-65  ,onComplete=flybackup4} )
  randomtime()
end


function flybackup2(obj)
--  print("flyback up there")
--  transition.to( obj, {time=4000,y=60} )
  transition.to( obj, {time=timer,x=screenLeft+340,y=screenTop+50  ,onComplete=flybackup3} )
  randomtime()
end
...
function flybackup1(obj)
--  print("flyback up there")
--  transition.to( obj, {time=4000,y=60} )
  transition.to( obj, {time=timer,x=screenLeft+420,y=screenBottom-65,onComplete=flybackup2} )
  randomtime()
end
...
function flybackdown(obj)
  transition.to( obj, {time=timer  ,x=screenLeft+340,y=screenTop+50, onComplete=flybackup1 } )
...
--  print("flyback up there")
--  transition.to( obj, {time=4000,y=60} )
  transition.to( obj, {time=timer,x=screenLeft+230,y=screenBottom-65 ,onComplete=flybackdown} )
  randomtime()
end
...
function Startgame()
  print("tapped")
  -----------remove items from create screen----------------------
  ...
  gameListeners('add')
  generatecoin()
  enemy1=display.newImage(enemygroup,"images/enemy/enemy1.png")

  enemy1.x=screenLeft+100
  enemy1.y=screenBottom-65 --screenTop+50
  enemy1.width=40
  enemy1.height=40

  -- enemy2=display.newImage(enemygroup,"images/enemy/enemy2.png")
  -- enemy2.x=screenRight-220
  -- enemy2.y=screenBottom-52
  -- enemy2.width=40
  -- enemy2.height=40
  -- enemy2=display.newImage("images/enemy/enemy1.png")
  -- enemy2.x=screenLeft+300
  -- enemy2.y=screenBottom-52
  -- enemy2.width=40
  -- enemy2.height=40

  -- transition.to( enemy2, {delay=3000,time=4000  ,y=screenBottom-52, onComplete=flybackup } )
--  transition.to( enemy1, {time=20000  ,rotation=180, onComplete=flybackup } )


  -- transition.to( enemy2, {delay=3000,time=4000  ,y=screenBottom-52, onComplete=flybackup } )
 transition.to( enemy1, {time=4000  ,x=screenLeft+160,y=screenTop+50, onComplete=flybackup } )
  ----------------------------------------------------------------------------
