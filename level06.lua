...
function replayfun()
  composer.removeScene("replay6" )
  composer.gotoScene( "replay6")
end
...
function flybackdown(obj)
  transition.to( obj, {time=timer  ,rotation=180, onComplete=flybackup } )
...
--  transition.to( obj, {time=4000,y=60} )
  transition.to( obj, {time=timer ,rotation=-180,onComplete=flybackdown} )
  randomtime()
end
...
--transition.to( enemy1, {time=10000  ,y=screenBottom-52, onComplete=flybackup } )
...
function Startgame()
  ...
  gameListeners('add')
  generatecoin()
  enemy1=display.newImage(enemygroup,"images/enemy/enemy5.png")
  enemy1.x=centerX-20
  enemy1.y=centerY
  enemy1.width=180
  enemy1.height=60
