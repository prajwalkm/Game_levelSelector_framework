...
function replayfun()
  composer.removeScene("replay5" )
  composer.gotoScene( "replay5")
end
...
function flybackdown(obj)
  transition.to( obj, {time=timer  ,x=screenLeft+430,rotation=720, onComplete=flybackup } )
...
--  transition.to( obj, {time=4000,y=60} )
  transition.to( obj, {time=timer,x=screenLeft+100  ,rotation=720,onComplete=flybackdown} )
  randomtime()
end
...
function Startgame()
  ...
  enemy2=display.newImage(enemygroup,"images/enemy/enemy1.png")
  enemy2.x=screenLeft+430
  enemy2.y=screenBottom-70
  enemy2.width=40
  enemy2.height=40
  -- enemy2=display.newImage("images/enemy/enemy1.png")
...
transition.to( enemy2, {delay=3000,time=4000  ,x=screenLeft+100, onComplete=flybackup } )
transition.to( enemy1, {time=4000  ,x=screenLeft+430, onComplete=flybackup } )
  ----------------------------------------------------------------------------
